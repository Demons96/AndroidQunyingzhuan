...
//    private SeekBar mSeekbarhue, mSeekbarSaturation, mSeekbarLum;   //滑动选择按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initSeekBar((SeekBar) findViewById(R.id.seekbarHue));           //色调
        initSeekBar((SeekBar) findViewById(R.id.seekbarSaturation));    //饱和度
        initSeekBar((SeekBar) findViewById(R.id.seekbatLum));           //亮度
